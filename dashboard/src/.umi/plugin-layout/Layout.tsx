...
/// <reference types="D:/workspaces/wingman/dashboard/node_modules/@ant-design/pro-components" />
...
import {
  ProLayout,
} from "D:/workspaces/wingman/dashboard/node_modules/@ant-design/pro-components";
import './Layout.css';
...
const { formatMessage } = useIntl();
  ...
  return (
    <ProLayout
      route={route}
      location={location}
      title={userConfig.title || 'wingman-dashboard'}
      navTheme="dark"
      siderWidth={256}
      onMenuHeaderClick={(e) => {
        e.stopPropagation();
