...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/remote/recordings/{name}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "录像文件名（basename，.mjs 后缀）",
                        "name": "name",
                        "in": "path",
                        "required": true
                    }
        ...
        "/remote/recordings/{name}/download": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/remote/tickets": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "连接参数（protocol: rdp/vnc/ssh）",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "handlers.ticketRequest": {
            ...
            "properties": {
                ...
                "record": {
                    "description": "会话录制（需服务端已配置录制，设计 §16）",
                    "type": "boolean"
                },
                "username": {
                    "type": "string"
