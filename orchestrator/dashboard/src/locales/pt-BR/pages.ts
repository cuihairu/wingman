export default {
  ...
  'pages.agents.recordings.checkboxLabel':
    'Gravação de sessão (requer caminho de gravação configurado no servidor; teclas digitadas nunca são gravadas)',
  'pages.agents.recordings.title': 'Gravações de sessão',
  'pages.agents.recordings.close': 'Fechar',
  'pages.agents.recordings.unavailable': 'Gravações de sessão indisponíveis',
  'pages.agents.recordings.retry': 'Tentar novamente',
  'pages.agents.recordings.empty':
    'Nenhuma gravação ainda (marque "Gravação de sessão" ao conectar para gerar uma)',
  'pages.agents.recordings.colName': 'Nome do arquivo',
  'pages.agents.recordings.colSize': 'Tamanho',
  'pages.agents.recordings.colTime': 'Gravado em',
  'pages.agents.recordings.colActions': 'Ações',
  'pages.agents.recordings.play': 'Reproduzir',
  'pages.agents.recordings.download': 'Baixar',
  'pages.agents.recordings.deleteConfirm': 'Excluir {name}?',
  'pages.agents.recordings.deleteIrreversible': 'Não será possível desfazer',
  'pages.agents.recordings.delete': 'Excluir',
  'pages.agents.recordings.listFailed': 'Falha ao listar gravações de sessão',
  'pages.agents.recordings.downloadFailed': 'Falha ao baixar a gravação de sessão',
  'pages.agents.recordings.deleted': '{name} excluído',
  'pages.agents.recordings.deleteFailed': 'Falha ao excluir a gravação de sessão',
  // ===== Scripts =====
