...
- 💬 讨论与协作：请使用当前 Wingman 仓库的讨论区或内部协作渠道
- 🐛 问题反馈：请提交到当前 Wingman 仓库的问题跟踪系统
...
- ✅ 实时预览功能
  > 历史文档说明
  >
  > 本文档描述的 `workspace-editor` 相关能力并非当前 `wingman` 默认可用功能。如需以当前仓库为准，请优先参考 `orchestrator/dashboard/README.md` 与 `orchestrator/server` 的实际代码实现。
