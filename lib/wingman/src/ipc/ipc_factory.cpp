...
using UnixSocketChannel = wingman::ipc::linux::UnixSocketChannel;
#elif defined(__APPLE__)
#include "wingman/platform/mac/unix_socket_channel.hpp"
using UnixSocketChannel = wingman::ipc::macos::UnixSocketChannel;
#endif
