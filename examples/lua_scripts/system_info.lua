...
-- 网络适配器
print("\n--- 网络适配器 ---")
local adapters = system.getNetworkAdapters()
...
-- 显示器信息
print("\n--- 显示器信息 ---")
local displays = system.getDisplayInfo()
...
-- 其他信息
print("\n--- 其他信息 ---")
print(string.format("  系统运行时间: %d 秒", system.getUptime()))
print(string.format("  当前时间: %s", system.getDateTime()))
print(string.format("  进程数: %d", system.getProcessCount()))
print(string.format("  线程数: %d", system.getThreadCount()))
