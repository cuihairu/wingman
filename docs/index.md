...
features:
  ...
  - title: 🌐 远程控制
    details: 支持 TCP Server/Client 模式，可被 Nebula 统一调度
  - title: 🐛 强大的调试
...
- 支持**远程控制**，可作为 Nebula 分布式游戏调度系统的执行引擎
...
Wingman 是三个项目中的**执行层**，专注于单机的游戏自动化执行，不涉及账号管理、分布式调度等功能。
