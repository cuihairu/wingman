...
- [ ] C++ 生产代码继续补测（v6 中间态 81.2% 行/13106 行）。剩余缺口大头：script_manager 533 行、misc_modules UIA 注册表段、x11 平台实现（screen 171@33%/xtest_input 189@50%/capture 124@50%/clipboard/recorder，Xvfb 可测部分）、notify 208 行、posix_process 138 行@34%、http.cpp 123 行、ml/game_profile/clipboard/filewatcher 胶水零头
